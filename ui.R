        ...
        div(class = "tab-head", div(class = "tab-head-text",
          h4("How diverse is this site?",
             info_pop("What richness is — and isn't",
               ...
               p("In drylands the two can pull apart: a richness uptick is often introduced annual/forb addition after disturbance — ", tags$b("more taxa, less native function"), ". More species ≠ more biomass or a healthier system."),
        ...
        card(full_screen = TRUE,
          card_head("bullseye", "Richness × introduced-cover, by plot",
            info_pop("Reading this",
              ...
              p("More species (right) is ", tags$b("not"), " automatically better: richness is composition, not health. In drylands a richness uptick can be introduced-forb addition — read the y-axis (native vs introduced cover), not just the count."))),
